              ...
              manager.startDeviceScan(null, null, async (error, device) => {
                ...
                if (device) {
                  if (device.name != null) {
                    ...
                    if (device.name == 'HD 450SE') {
                      console.log(
                        'Started connection to OnePlus Bullets Wireless Z2',
                      );
                      await device
                        .connect()
                        .then(device => {
                          console.log(
                            'Connected to OnePlus Bullets Wireless Z2',
                          );
                        ...
                        .catch(error => {
                          console.log(
                            'Error occured white connecting to OnePlus Bullets Wireless Z2' +
                              error,
                          );
                        });
                      console.log(
                        'Finished connection to OnePlus Bullets Wireless Z2',
                      );
                    }
                  }
                }
